...
public class PersonController {
	...
	public PersonController(PersonService personaService) {
	...
	public ResponseEntity<Persona> create(@RequestBody PersonaRequest persona) {
	...
	public ResponseEntity<Persona> update(@RequestBody PersonaRequest request, @PathVariable("tipoDocumento") TipoDocumento tipoDocumento, @PathVariable("documento") String documento) {
